    ...
    <x-slot name="header">
        <div class="flex flex-wrap items-center gap-3">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-600">Arsip kontak dari bulan-bulan sebelumnya. Data bersifat <strong>read-only</strong>.</p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="panel fade-in-up">
                ...
                >
                    ...
                    <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-12">
                        ...
                        {{-- Sub-leader filter (Toploker only) --}}
                        @if ($isToploker)
                            <div class="filter-dropdown xl:col-span-3" x-data="{ open: false }">
                                <button
                                    type="button"
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        @if (array_filter($filters))
                            <a href="{{ route('leader.history.index') }}" class="btn-subtle">Reset</a>
                        @endif
                    </div>
                </form>
            </div>
