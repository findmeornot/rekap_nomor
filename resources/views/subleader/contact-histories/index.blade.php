<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-600">Arsip nomor yang sudah kamu input di bulan-bulan sebelumnya. Data bersifat <strong>read-only</strong>.</p>
        </div>
    </x-slot>
            ...
            <div class="panel fade-in-up relative z-20">
                ...
                >
                    ...
                    <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-12">
                        ...
                        {{-- Archive Period --}}
                        <div class="filter-dropdown xl:col-span-4" x-data="{ open: false }">
                            <button
                                type="button"
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        @if (array_filter($filters))
                            <a href="{{ route('subleader.history.index') }}" class="btn-subtle">Reset</a>
                        @endif
                    </div>
                </form>
            </div>
            ...
            <div class="panel fade-in-up">
                ...
                @if ($histories->isEmpty())
                    <div class="flex flex-col items-center justify-center py-16 text-center">
                        ...
                        @else
                            <p class="mt-1 text-xs text-slate-400">History akan muncul setelah arsip bulanan pertama dibuat.</p>
                        @endif
                    </div>
                @else
